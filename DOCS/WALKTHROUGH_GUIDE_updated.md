...
The **Myntra Trust-Verified Architecture MVP** addresses the primary friction point in online fashion e-commerce: **48.7% Quality Doubt hesitation** (4,617 mentions, #1 ranked opportunity area) — the top blocker stalling conversion, despite **94.4% of wishlist adds representing an active purchase journey** (84.4% genuine purchase intent + 10.0% comparison shortlisting; Source: Q1, n=8,182). The wishlist is not a "graveyard" — the research shows it functions as an active, high-intent funnel that quality doubt is choking off before checkout.
...
- **Neutralizing 48.7% Quality Doubt:** Corpus research (KPI Opportunity Matrix, 4,617 mentions) indicates quality doubt is the single largest checkout hesitation. Aggregate metrics provide immediate empirical reassurance.
...
### Step 7: Post-Purchase Review & Verified Badge Collection

```
+-----------------------------------------------------------------------------+
|  [✕]  VERIFIED BUYER REVIEW                                                 |
|  Post-purchase feedback for Order #MYN-89342                                |
|                                                                             |
|  ℹ️ Disclaimer: This is an approximation of how a Myntra review screen       |
|     might look. It may vary from the original one.                          |
|                                                                             |
|  ⭐ Overall Product Rating: [ ★ ★ ★ ★ ★ ] Loved it!                         |
|                                                                             |
|  🛡️ Authenticity: Does this feel genuine?                                   |
|     (•) [✓ 100% Genuine & Authentic]   ( ) [✕ Feels Off / Lower Quality]    |
|                                                                             |
|  📏 Fit & Sizing: How is the sizing and fit?                                |
|     (•) [✓ True to Size / Perfect Fit] ( ) [✕ Sizing Runs Tight / Loose]    |
|                                                                             |
|  📷 Customer Photos & Videos:                                               |
|     [ + Add Photos ]  [ + Add Video ]                                       |
|     [✓] Taken in Natural Daylight (adds Daylight Verified tag)              |
|                                                                             |
|  [ SUBMIT VERIFIED REVIEW & BADGES ]                                        |
+-----------------------------------------------------------------------------+
```

#### 1. User Experience & Screen Action
- **Delivered Order Review Gating:** Accessible under **Profile → Orders** for delivered purchases, ensuring zero unverified spam reviews.
- **Accessible Badge Option Buttons:** Every attribute question (Authenticity, Sizing Fit, Photo Accuracy, Fabric Feel, Comfort) displays **all available choices as distinct buttons** rather than hidden cycling states.
- **UGC Photos & Videos Upload:** Buyers can attach unedited customer pictures and video clips with a **Natural Daylight** environment toggle.
- **Prototype Disclaimer:** Explicitly marks the interface as an approximation of Myntra's post-purchase review interface.

#### 2. Architectural Rules & Research Rationale
- **Verified Buyer Data Pipeline:** Hooks seamlessly into Myntra's existing post-delivery review notifications to aggregate community trust metrics without requiring complex free-form typing.
- **Standardized Attribute Schema:** Structured binary/ternary choice buttons produce quantifiable dataset feeds for real-time badge aggregation algorithms.
...
| **7** | **Review Submission** | Rate delivered order & submit badges | Exclusively gated to delivered orders; all badge choices displayed; media uploads |
...
- **Prototype Approximation Disclaimer:** *"This is an approximation of how a Myntra review screen might look. It may vary from the original one."*
